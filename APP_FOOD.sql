-- Active: 1685611898543@@localhost@3306@APP_FOOD
...
VALUES 
    ...
    ('Trần Thị B', 'tranthib@gmail.com', 'password2'),
    ('Lê Văn C', 'levanc@gmail.com', 'password3'),
    ('Phạm Thị D', 'phamthid@gmail.com', 'password4'),
    ('Hoàng Văn E', 'hoangvane@gmail.com', 'password5'),
    ('Nguyễn Thị F', 'nguyenthif@gmail.com', 'password6'),
    ('Trần Văn G', 'tranvang@gmail.com', 'password7'),
    ('Lê Thị H', 'lethih@gmail.com', 'password8'),
    ('Phạm Văn I', 'phamvani@gmail.com', 'password9'),
    ('Hoàng Thị K', 'hoangthik@gmail.com', 'password10'),
    ('Nguyễn Văn L', 'nguyenvanl@gmail.com', 'password11'),
    ('Trần Thị M', 'tranthim@gmail.com', 'password12'),
    ('Lê Văn N', 'levann@gmail.com', 'password13'),
    ('Phạm Thị P', 'phamthip@gmail.com', 'password14'),
    ('Hoàng Văn Q', 'hoangvanq@gmail.com', 'password15'),
    ('Nguyễn Thị R', 'nguyenthir@gmail.com', 'password16'),
    ('Trần Văn S', 'tranvans@gmail.com', 'password17'),
    ('Lê Thị T', 'lethit@gmail.com', 'password18'),
    ('Phạm Văn U', 'phamvanu@gmail.com', 'password19'),
    ('Hoàng Thị V', 'hoangthiv@gmail.com', 'password20');
